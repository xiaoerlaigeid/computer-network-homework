...
class Transport:
    ...
    def createWindow(self, root):
        ...
        self.radio1 = Radiobutton(root, text = 'Host1', 
            command = self.ClickRadiobutton, value = '127.0.0.1|30000|Host2|Host1|', variable = self.radioVar)
        self.radio1.grid(row = 2, column = 0, sticky = E, ipadx = 10)

        self.radio2 = Radiobutton(root, text = 'Host3', 
            command = self.ClickRadiobutton, value = '127.0.2.1|30020|Host2|Host3|', variable = self.radioVar)

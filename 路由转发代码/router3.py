...
'''
routing_table = [
    ['127.0.2.1', '127.0.2.1', 30020],
    ['127.0.0.1', '127.0.1.2', 40010],
    ['127.0.1.1', '127.0.1.2', 40010]
]
class Transport:
    def __init__(self):
        self.root = Tk()
        self.root.title('Routing3')
